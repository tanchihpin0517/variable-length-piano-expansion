...
# training setup
parser.add_argument('--dict-file', type=str, default='/screamlab/tanch/variable-length-piano-infilling/dictionary.pickle')
parser.add_argument('--data-file', type=str, default='/screamlab/tanch/variable-length-piano-infilling/worded_data.pickle')
parser.add_argument('--train', default=False, action='store_true')
parser.add_argument('--save-path', type=str, default="/screamlab/tanch/variable-length-piano-infilling/trained-models/partial-target-test")
...
parser.add_argument('--test-data-file', type=str, default='/screamlab/tanch/variable-length-piano-infilling/worded_data.pickle')
parser.add_argument('--ckpt-path', type=str, default="/screamlab/tanch/variable-length-piano-infilling/trained-model/pretrain.ckpt")
...
class XLNetForPredictingMiddleNotes(torch.nn.Module):
    ...
    def expand(self, data=None, n_songs=10, song_idx=0, start_bar=None, n_gen_bars=4):
        ...
        end_bar9 = start_pos + 16
        print(start_bar6, end_bar9)
        ...
        for sidx in range(n_songs):
            ...
            to_midi(input_ids, self.w2e, os.path.join(save_midi_folder, "song%d_%d_%dbars.midi" % (song_idx, sidx, 12 + n_gen_bars)))

        print("=" * 80)

    def predict(self, data=None, n_songs=10, song_idx=0, target_start=None, target_len=None, n_gen_bars=4):
        datum = np.array(data[song_idx:song_idx+1][0])[None]
        seq_len = datum.shape[1]
...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        model.expand(data=test_data, n_songs=1, song_idx=325, start_bar=7, n_gen_bars=4)
        model.expand(data=test_data, n_songs=1, song_idx=325, start_bar=9, n_gen_bars=4)
        model.expand(data=test_data, n_songs=1, song_idx=450, start_bar=5, n_gen_bars=4)
        model.expand(data=test_data, n_songs=1, song_idx=450, start_bar=7, n_gen_bars=4)
        model.expand(data=test_data, n_songs=1, song_idx=550, start_bar=8, n_gen_bars=4)
        model.expand(data=test_data, n_songs=1, song_idx=550, start_bar=6, n_gen_bars=4)
        model.expand(data=test_data, n_songs=1, song_idx=600, start_bar=6, n_gen_bars=4)
        model.expand(data=test_data, n_songs=1, song_idx=600, start_bar=8, n_gen_bars=4)
        model.expand(data=test_data, n_songs=1, song_idx=700, start_bar=12, n_gen_bars=4)
        model.expand(data=test_data, n_songs=1, song_idx=700, start_bar=10, n_gen_bars=4)
        model.expand(data=test_data, n_songs=1, song_idx=1000, start_bar=8, n_gen_bars=4)
        model.expand(data=test_data, n_songs=1, song_idx=1000, start_bar=10, n_gen_bars=4)
        model.expand(data=test_data, n_songs=1, song_idx=1775, start_bar=9, n_gen_bars=4)
        model.expand(data=test_data, n_songs=1, song_idx=1775, start_bar=7, n_gen_bars=4)
